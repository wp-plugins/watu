...
<h2><?php _e("Manage Exam", 'watu'); ?></h2>
	...
	if(count($all_test)) {
		foreach($all_test as $quiz) {
			...
			<td><a href='edit.php?page=watu/exam_form.php&amp;quiz=<?php echo $quiz->ID?>&amp;action=edit' class='edit'><?php _e('Edit', 'watu'); ?></a></td>
			<td><a href='edit.php?page=watu/exam.php&amp;action=delete&amp;quiz=<?php echo $quiz->ID?>' class='delete' onclick="return confirm('<?php echo  addslashes(__("You are about to delete this quiz? This will delete all the questions and answers within this quiz. Press 'OK' to delete and 'Cancel' to stop.", 'watu'))?>');"><?php e('Delete')?></a></td>
			</tr>
	<?php
			}
		} else {
	...
	<a href="edit.php?page=watu/exam_form.php&amp;action=new"><?php _e("Create New Exam", 'watu')?></a>
	</div>
	<div id="watu-sidebar">
