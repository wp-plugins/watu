...
function watu_exam() {
	...
	if(isset($_REQUEST['submit'])) {
		if($_REQUEST['action'] == 'edit') { //Update goes here
			...
			(name, description, final_screen,  added_on, randomize, single_page, show_answers, require_login, notify_admin) 
